...
# Load player data
# df = pd.read_csv("player_data.csv") (If you want to use the real data from the google sheet)
...
for col in ['var_accuracy','var_reaction_ms','var_shots_hit','var_shots_fired']:
...
features_for_clustering = ['accuracy','avg_reaction_ms','shots_hit','shots_fired',
                           'var_accuracy','var_reaction_ms','var_shots_hit','var_shots_fired']
