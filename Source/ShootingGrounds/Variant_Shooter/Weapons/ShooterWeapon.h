 ...
 */
UCLASS(abstract)
class SHOOTINGGROUNDS_API AShooterWeapon : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	/** Fire a line trace towards the target location */
	virtual bool GunTraceByChannel(FHitResult& Hit, FVector& ShotDirection, ECollisionChannel Channel);
